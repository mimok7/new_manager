    ...
    return (
        <>
            ...
            `}>
                ...
                {!loading && user && (
                    <div className="mx-3 mt-3 px-3 py-2.5 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100">
                        <div className="text-xs font-medium text-gray-800 truncate">{profile?.name || user.email}</div>
                        <div className="text-[10px] text-blue-600 font-medium uppercase tracking-wide mt-0.5">{role}</div>
                    </div>
                )}
