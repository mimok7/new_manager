...
export default function ShtCarPage() {
    ...
    const handleEditReservation = (reservation: ShtCarReservation) => {
        ...
        router.push(`/reservation-edit/sht?id=${encodeURIComponent(reservation.reservation_id)}`);
    };
                ...
                <div className="bg-white rounded-lg shadow-md p-3">
                    <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                type="date"
                                value={toKstDateKey(selectedDate)}
                                onChange={(e) => {
                            ...
                            <button
                                ...
                                className="px-2 py-1 bg-blue-50 text-blue-600 rounded-lg border border-blue-200 font-medium hover:bg-blue-100 whitespace-nowrap"
                            >
                                오늘
                            </button>
